...
namespace ng.Net1.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine(string.Format("GetExternalLogin:provider:{0},error:{1}", provider, error));
            ng.Net1.Controllers.BaseApiController.writeLog(string.Format("GetExternalLogin:provider:{0},error:{1}", provider, error));
            if (error != null)
            {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = ApplicationOAuthProvider.CreateProperties(user.UserName,user.Id.ToString());
        ...
        {
            ng.Net1.Controllers.BaseApiController.writeLog(string.Format("ExternalLogins:returnUrl:{0},generateState:{1}", returnUrl, generateState.ToString()));
        ...
        {
            ng.Net1.Controllers.BaseApiController.writeLog(string.Format("Register.model:{0}", model.ToString()));
