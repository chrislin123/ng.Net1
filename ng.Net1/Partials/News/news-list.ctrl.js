app.controller('NewsCtrl', ['$scope', '$http', '$cookies', '$cookieStore', '$sce', '$q', 'rootUrl',
    function ($scope, $http, $cookies, $cookieStore, $sce, $q, rootUrl) {
        ...
        $scope.currentUrl = "http://api.falcota.com/everanhospital/news/create.php" + "?token=" + $scope.token;
